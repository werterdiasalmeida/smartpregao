...
include_once APPRAIZ . "seguranca/www/_verificaVencimentoFatura.php";
...
$html = "Alterando a situação de fatura para faturas vencidas";
$mFatura = new Fatura();
$result = $mFatura->alterarSituacaoDeFaturasParaVencida();
$mFatura->commit();
$html .= "Fom da Execução";
