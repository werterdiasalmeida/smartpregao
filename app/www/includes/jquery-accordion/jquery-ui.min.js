...
(function(a, c) {
	function d(h, g) {
		...
		if ("area" === i) {
			g = h.parentNode;
			i = g.name;
			if (!h.href || !i || g.nodeName.toLowerCase() !== "map")
				return false;
			h = a("img[usemap=#" + i + "]")[0];
			return !!h && e(h)
		}
		return (/input|select|textarea|button|object/.test(i) ? !h.disabled
				: "a" == i ? h.href || g : g)
				&& e(h)
	}
	function e(h) {
	...
	if (!a.ui.version) {
		...
		a.fn
				.extend( {
					...
					scrollParent : function() {
						...
						return /fixed/.test(this.css("position")) || !h.length ? a(document)
								: h
					},
					zIndex : function(h) {
						if (h !== c)
					...
					disableSelection : function() {
						return this.bind((a.support.selectstart ? "selectstart"
								: "mousedown")
								+ ".ui-disableSelection", function(h) {
							h.preventDefault()
						})
					},
		...
		a.each( [ "Width", "Height" ],
				function(h, g) {
					function i(l, o, n, k) {
						a.each(b,
								function() {
									o -= parseFloat(a.curCSS(l, "padding"
											+ this, true)) || 0;
									if (n)
										o -= parseFloat(a.curCSS(l, "border"
												+ this + "Width", true)) || 0;
									if (k)
										o -= parseFloat(a.curCSS(l, "margin"
												+ this, true)) || 0
								});
						return o
					}
					var b = g === "Width" ? [ "Left", "Right" ] : [ "Top",
							"Bottom" ], f = g.toLowerCase(), j = {
		...
		a(function() {
			var h = document.body, g = h.appendChild(g = document
					.createElement("div"));
			a.extend(g.style, {
				minHeight : "100px",
				height : "auto",
		...
		a.extend(a.ui, {
			plugin : {
				...
				call : function(h, g, i) {
					if ((g = h.plugins[g]) && h.element[0].parentNode)
						for ( var b = 0; b < g.length; b++)
							h.options[g[b][0]] && g[b][1].apply(h.element, i)
				}
			},
			contains : function(h, g) {
				return document.compareDocumentPosition ? h
						.compareDocumentPosition(g) & 16 : h !== g
						&& h.contains(g)
			},
...
(function(a, c) {
	...
	a.widget.bridge = function(h, g) {
		a.fn[h] = function(i) {
			var b = typeof i === "string", f = Array.prototype.slice.call(
					arguments, 1), j = this;
			...
			b ? this.each(function() {
				var l = a.data(this, h), o = l && a.isFunction(l[i]) ? l[i]
						.apply(l, f) : l;
				if (o !== l && o !== c) {
					j = o;
					return false
	...
	a.Widget.prototype = {
		...
		_setOption : function(h, g) {
			this.options[h] = g;
			if (h === "disabled")
				this.widget()[g ? "addClass" : "removeClass"](
						this.widgetBaseClass + "-disabled ui-state-disabled")
		...
		_trigger : function(h, g, i) {
			...
			g = a.Event(g);
			g.type = (h === this.widgetEventPrefix ? h : this.widgetEventPrefix
					+ h).toLowerCase();
			i = i || {};
			if (g.originalEvent) {
			...
			return !(a.isFunction(b) && b.call(this.element[0], g, i) === false || g
					.isDefaultPrevented())
		}
	}
})(jQuery);
					...
					"ui.mouse",
					{
						...
						_mouseDown : function(c) {
							...
							if (!c.originalEvent.mouseHandled) {
								...
								var d = this, e = c.which == 1, h = typeof this.options.cancel == "string" ? a(
										c.target).closest(this.options.cancel).length
										: false;
								if (!e || h || !this._mouseCapture(c))
									return true;
...
(function(a) {
							...
							var d = this.options, e = this.cssPosition == "absolute"
									&& !(this.scrollParent[0] != document && a.ui
											.contains(this.scrollParent[0],
													this.offsetParent[0])) ? this.offsetParent
									: this.scrollParent, h = /(html|body)/i
									.test(e[0].tagName), g = c.pageX, i = c.pageY;
							if (this.originalPosition) {
								var b;
								if (this.containment) {
									if (this.relative_container) {
										b = this.relative_container.offset();
										b = [ this.containment[0] + b.left,
												this.containment[1] + b.top,
												this.containment[2] + b.left,
												this.containment[3] + b.top ]
									} else
										b = this.containment;
									if (c.pageX - this.offset.click.left < b[0])
										g = b[0] + this.offset.click.left;
									if (c.pageY - this.offset.click.top < b[1])
										i = b[1] + this.offset.click.top;
									if (c.pageX - this.offset.click.left > b[2])
										g = b[2] + this.offset.click.left;
									if (c.pageY - this.offset.click.top > b[3])
										i = b[3] + this.offset.click.top
								}
								if (d.grid) {
									i = d.grid[1] ? this.originalPageY
											+ Math
													.round((i - this.originalPageY)
															/ d.grid[1])
											* d.grid[1]
											: this.originalPageY;
									i = b ? !(i - this.offset.click.top < b[1] || i
											- this.offset.click.top > b[3]) ? i
											: !(i - this.offset.click.top < b[1]) ? i
													- d.grid[1]
													: i + d.grid[1]
											: i;
									g = d.grid[0] ? this.originalPageX
											+ Math
													.round((g - this.originalPageX)
															/ d.grid[0])
											* d.grid[0]
											: this.originalPageX;
									g = b ? !(g - this.offset.click.left < b[0] || g
											- this.offset.click.left > b[2]) ? g
											: !(g - this.offset.click.left < b[0]) ? g
													- d.grid[0]
													: g + d.grid[0]
											: g
								}
	...
	a.ui.plugin
			.add(
					...
					{
						start : function(c, d) {
							var e = a(this).data("draggable"), h = e.options, g = a
									.extend( {}, d, {
										item : e.element
									});
							e.sortables = [];
							a(h.connectToSortable).each(function() {
								...
								if (i && !i.options.disabled) {
									...
									i.refreshPositions();
									i._trigger("activate", c, g)
								}
							})
						},
						stop : function(c, d) {
							var e = a(this).data("draggable"), h = a.extend(
									{}, d, {
										item : e.element
									});
							a
	...
	a.ui.plugin
			.add(
					...
					"scroll",
					{
						...
						drag : function(c) {
							var d = a(this).data("draggable"), e = d.options, h = false;
							if (d.scrollParent[0] != document
									&& d.scrollParent[0].tagName != "HTML") {
								if (!e.axis || e.axis != "x")
									if (d.overflowOffset.top
											+ d.scrollParent[0].offsetHeight
											- c.pageY < e.scrollSensitivity)
										d.scrollParent[0].scrollTop = h = d.scrollParent[0].scrollTop
												+ e.scrollSpeed;
									else if (c.pageY - d.overflowOffset.top < e.scrollSensitivity)
										d.scrollParent[0].scrollTop = h = d.scrollParent[0].scrollTop
												- e.scrollSpeed;
								if (!e.axis || e.axis != "y")
									if (d.overflowOffset.left
											+ d.scrollParent[0].offsetWidth
											- c.pageX < e.scrollSensitivity)
										d.scrollParent[0].scrollLeft = h = d.scrollParent[0].scrollLeft
												+ e.scrollSpeed;
									else if (c.pageX - d.overflowOffset.left < e.scrollSensitivity)
										d.scrollParent[0].scrollLeft = h = d.scrollParent[0].scrollLeft
												- e.scrollSpeed
							} else {
								if (!e.axis || e.axis != "x")
							...
							h !== false && a.ui.ddmanager && !e.dropBehaviour
	...
	a.ui.plugin
			.add(
					...
					"snap",
					{
						...
						drag : function(c, d) {
							for ( var e = a(this).data("draggable"), h = e.options, g = h.snapTolerance, i = d.offset.left, b = i
									+ e.helperProportions.width, f = d.offset.top, j = f
								...
								if (o - g < i && i < n + g && k - g < f
									...
									e.snapElements[l].snapping = p || q || s
											|| r || u
								} else {
	...
	a.ui.plugin.add("draggable", "stack", {
		start : function() {
			...
			c = a.makeArray(a(c.stack)).sort(
					function(e, h) {
						return (parseInt(a(e).css("zIndex"), 10) || 0)
...
(function(a) {
	...
	a.ui.intersect = function(c, d, e) {
		if (!d.offset)
			return false;
		var h = (c.positionAbs || c.position.absolute).left, g = h
				+ c.helperProportions.width, i = (c.positionAbs || c.position.absolute).top, b = i
				+ c.helperProportions.height, f = d.offset.left, j = f
				+ d.proportions.width, l = d.offset.top, o = l
				+ d.proportions.height;
		switch (e) {
		case "fit":
			return f <= h && g <= j && l <= i && b <= o;
		case "intersect":
			return f < h + c.helperProportions.width / 2
					&& g - c.helperProportions.width / 2 < j
					&& l < i + c.helperProportions.height / 2
					&& b - c.helperProportions.height / 2 < o;
		case "pointer":
			return a.ui.isOver((c.positionAbs || c.position.absolute).top
					...
					(c.positionAbs || c.position.absolute).left
							+ (c.clickOffset || c.offset.click).left, l, f,
					d.proportions.height, d.proportions.width);
		case "touch":
			return (i >= l && i <= o || b >= l && b <= o || i < l && b > o)
					&& (h >= f && h <= j || g >= f && g <= j || h < f && g > j);
		default:
			return false
		}
	};
	a.ui.ddmanager = {
		...
		prepareOffsets : function(c, d) {
			var e = a.ui.ddmanager.droppables[c.options.scope] || [], h = d ? d.type
					: null, g = (c.currentItem || c.element).find(
					":data(droppable)").andSelf(), i = 0;
			a: for (; i < e.length; i++)
				if (!(e[i].options.disabled || c
						&& !e[i].accept.call(e[i].element[0], c.currentItem
								|| c.element))) {
					for ( var b = 0; b < g.length; b++)
					...
					if (e[i].visible) {
						h == "mousedown" && e[i]._activate.call(e[i], d);
		...
		dragStart : function(c, d) {
			c.element.parentsUntil("body").bind(
					"scroll.droppable",
					function() {
					...
					.each(
							...
							function() {
								if (!(this.options.disabled || this.greedyChild || !this.visible)) {
									var e = a.ui.intersect(c, this,
											this.options.tolerance);
									if (e = !e && this.isover == 1 ? "isout"
											: e && this.isover == 0 ? "isover"
													: null) {
										var h;
...
(function(a) {
			...
			.widget(
					...
					a.ui.mouse,
					{
						...
						_mouseStart : function(e) {
							...
							this._renderProxy();
							g = c(this.helper.css("left"));
							var b = c(this.helper.css("top"));
							if (h.containment) {
						...
						_mouseDrag : function(e) {
							...
							if (!i)
								return false;
							g = i.apply(this, [ e, e.pageX - g.left || 0,
									e.pageY - g.top || 0 ]);
						...
						_mouseStop : function(e) {
							...
							if (this._helper) {
								...
								i = parseInt(g.element.css("left"), 10)
										...
										|| null;
								var f = parseInt(g.element.css("top"), 10)
						...
						_updateVirtualBoundaries : function(e) {
							...
							h = {
								...
								maxWidth : d(h.maxWidth) ? h.maxWidth
										: Infinity,
								minHeight : d(h.minHeight) ? h.minHeight : 0,
								maxHeight : d(h.maxHeight) ? h.maxHeight
										: Infinity
							};
						...
						_respectSize : function(e) {
							var h = this._vBoundaries, g = this.axis, i = d(e.width)
									&& h.maxWidth && h.maxWidth < e.width, b = d(e.height)
									&& h.maxHeight && h.maxHeight < e.height, f = d(e.width)
									&& h.minWidth && h.minWidth > e.width, j = d(e.height)
									&& h.minHeight && h.minHeight > e.height;
							if (f)
								e.width = h.minWidth;
							if (j)
							...
							var l = this.originalPosition.left
									...
									+ this.size.height, n = /sw|nw|w/.test(g);
							g = /nw|ne|n/.test(g);
							if (f && n)
								e.left = l - h.minWidth;
							if (i && n)
							...
							if (b && g)
								e.top = o - h.maxHeight;
							if ((h = !e.width && !e.height) && !e.left && e.top)
								e.top = null;
						...
						_proportionallyResize : function() {
							if (this._proportionallyResizeElements.length)
								for ( var e = this.helper || this.element, h = 0; h < this._proportionallyResizeElements.length; h++) {
									...
									if (!this.borderDif) {
										var i = [ g.css("borderTopWidth"),
												g.css("borderRightWidth"),
												g.css("borderBottomWidth"),
												g.css("borderLeftWidth") ], b = [
												g.css("paddingTop"),
												g.css("paddingRight"),
												g.css("paddingBottom"),
												g.css("paddingLeft") ];
						...
						_renderProxy : function() {
							...
							if (this._helper) {
								...
								var h = a.browser.msie && a.browser.version < 7, g = h ? 1
										: 0;
								h = h ? 2 : -1;
	...
	a.ui.plugin.add("resizable", "alsoResize", {
		start : function() {
			...
			if (typeof e.alsoResize == "object" && !e.alsoResize.parentNode)
				if (e.alsoResize.length) {
					...
					a.each(e.alsoResize, function(g) {
						h(g)
					});
			else
				h(e.alsoResize)
		...
		stop : function() {
			...
			if (e._revertToRelativePosition) {
				...
				typeof h.alsoResize == "object" && !h.alsoResize.nodeType ? a
						.each(h.alsoResize, function(i) {
							g(i)
						}) : g(h.alsoResize)
			}
	...
	a.ui.plugin
			.add(
					...
					{
						stop : function(e) {
							var h = a(this).data("resizable"), g = h.options, i = h._proportionallyResizeElements, b = i.length
									&& /textarea/i.test(i[0].nodeName), f = b
									&& a.ui.hasScroll(i[0], "left") ? 0
									: h.sizeDiff.height;
							b = {
								width : h.size.width
										- (b ? 0 : h.sizeDiff.width),
								height : h.size.height - f
							};
							f = parseInt(h.element.css("left"), 10)
									+ (h.position.left - h.originalPosition.left)
									|| null;
							var j = parseInt(h.element.css("top"), 10)
							...
							h.element.animate(a.extend(b, j && f ? {
								...
								left : f
							} : {}),
									{
										...
										step : function() {
											var l = {
												width : parseInt(h.element
														.css("width"), 10),
												height : parseInt(h.element
														.css("height"), 10),
												top : parseInt(h.element
														.css("top"), 10),
												left : parseInt(h.element
														.css("left"), 10)
											};
			...
			.add(
					...
					"containment",
					{
						start : function() {
							...
							if (h = g instanceof a ? g.get(0) : /parent/
									.test(g) ? h.parent().get(0) : g) {
								...
								if (/document/.test(g) || g == document) {
									...
									j = a.ui.hasScroll(h, "left") ? h.scrollWidth
											: j;
						...
						resize : function(e) {
							...
							g = Math.abs((h._helper ? h.offset.left - f.left
									: h.offset.left - f.left)
									+ h.sizeDiff.width);
							i = Math.abs((h._helper ? h.offset.top - f.top
									: h.offset.top - i.top)
									+ h.sizeDiff.height);
							b = h.containerElement.get(0) == h.element.parent()
									.get(0);
							f = /relative|absolute/.test(h.containerElement
									.css("position"));
							if (b && f)
								g -= h.parentData.left;
						...
						stop : function() {
							var e = a(this).data("resizable"), h = e.options, g = e.containerOffset, i = e.containerPosition, b = e.containerElement, f = a(e.helper), j = f
									.offset(), l = f.outerWidth()
									- e.sizeDiff.width;
					...
					"grid",
					{
						resize : function() {
							...
							h.grid = typeof h.grid == "number" ? [ h.grid,
									h.grid ] : h.grid;
							var j = Math.round((g.width - i.width)
									/ (h.grid[0] || 1))
									* (h.grid[0] || 1);
							h = Math.round((g.height - i.height)
									/ (h.grid[1] || 1))
									* (h.grid[1] || 1);
							if (/^(se|s|e)$/.test(f)) {
			...
			.widget(
					...
					a.ui.mouse,
					{
						...
						_mouseDrag : function(c) {
							...
							this.dragged = true;
							if (!this.options.disabled) {
								var e = this.options, h = this.opos[0], g = this.opos[1], i = c.pageX, b = c.pageY;
								if (h > i) {
									var f = i;
									i = h;
									h = f
			...
			.widget(
					...
					a.ui.mouse,
					{
						...
						_mouseCapture : function(c, d) {
							...
							if (a.data(c.target, "sortable-item") == h)
								e = a(c.target);
							if (!e)
								return false;
						...
						_mouseStart : function(c, d, e) {
							...
							if (!e)
								for (e = this.containers.length - 1; e >= 0; e--)
									this.containers[e]._trigger("activate", c,
											h._uiHash(this));
							if (a.ui.ddmanager)
								a.ui.ddmanager.current = this;
							a.ui.ddmanager && !d.dropBehaviour
						...
						_intersectsWith : function(c) {
							var d = this.positionAbs.left, e = d
									...
									+ this.helperProportions.height, i = c.left, b = i
									+ c.width, f = c.top, j = f + c.height, l = this.offset.click.top, o = this.offset.click.left;
							l = h + l > f && h + l < j && d + o > i
									&& d + o < b;
							return this.options.tolerance == "pointer"
									...
									&& this.helperProportions[this.floating ? "width"
											...
											: "height"] ? l
									: i < d + this.helperProportions.width / 2
						...
						_intersectsWithSides : function(c) {
							...
							c = a.ui.isOverAxis(this.positionAbs.left
									+ this.offset.click.left, c.left + c.width
									/ 2, c.width);
							var e = this._getDragVerticalDirection(), h = this
									._getDragHorizontalDirection();
							return this.floating && h ? h == "right" && c
									|| h == "left" && !c : e
									&& (e == "down" && d || e == "up" && !d)
						},
						...
						_getItemsAsjQuery : function(c) {
							...
							if (h && c)
								for (c = h.length - 1; c >= 0; c--)
									for ( var g = a(h[c]), i = g.length - 1; i >= 0; i--) {
						...
						refreshPositions : function(c) {
							...
							if (this.options.custom
								...
								for (d = this.containers.length - 1; d >= 0; d--) {
									h = this.containers[d].element.offset();
									this.containers[d].containerCache.left = h.left;
									this.containers[d].containerCache.top = h.top;
						...
						_contactContainers : function(c) {
							for ( var d = null, e = null, h = this.containers.length - 1; h >= 0; h--)
								if (!a.ui.contains(this.currentItem[0],
									...
									if (this
										...
										this.containers[h]._trigger("out", c,
												this._uiHash(this));
										this.containers[h].containerCache.over = 0
									}
							if (d)
								if (this.containers.length === 1) {
									this.containers[e]._trigger("over", c, this
											._uiHash(this));
									...
									if (h || this.options.dropOnEmpty) {
										...
										this.options.placeholder.update(
												...
												this.placeholder);
										this.containers[e]._trigger("over", c,
												this._uiHash(this));
										this.containers[e].containerCache.over = 1
									}
								}
							...
							if (this.originalPosition) {
								...
								if (d.grid) {
									...
									i = this.containment ? !(i
											...
											: !(i - this.offset.click.top < this.containment[1]) ? i
													- d.grid[1]
													: i + d.grid[1]
											: i;
							...
							if (!a.ui.contains(this.element[0],
								...
								for (h = this.containers.length - 1; h >= 0; h--)
									if (a.ui.contains(
										...
										e.push(function(g) {
											return function(i) {
												g._trigger("receive", i, this
														._uiHash(this))
											}
										}.call(this, this.containers[h]));
										e.push(function(g) {
											return function(i) {
												g._trigger("update", i, this
														._uiHash(this))
											}
										}.call(this, this.containers[h]))
									}
...
jQuery.effects
		|| function(a, c) {
			...
			function e(n, k) {
				...
				do {
					m = a.curCSS(n, k);
					if (m != "" && m != "transparent" || a.nodeName(n, "body"))
						break;
					k = "backgroundColor"
			...
			function g(n) {
				...
				for (k in n) {
					m = n[k];
					if (m == null || a.isFunction(m) || k in o
			...
			function f(n) {
				if (!n || typeof n === "number" || a.fx.speeds[n])
					return true;
			...
			a.effects = {};
			a.each( [ "backgroundColor", "borderBottomColor",
					"borderLeftColor", "borderRightColor", "borderTopColor",
					"borderColor", "color", "outlineColor" ], function(n, k) {
			...
			a.effects.animateClass = function(n, k, m, p) {
				...
				return this.queue(function() {
					var q = a(this), s = q.attr("style") || " ", r = g(h
							.call(this)), u, v = q.attr("class");
			...
			a.fn
					.extend( {
						...
						toggleClass : function(n, k, m, p, q) {
							return typeof k == "boolean" || k === c ? m ? a.effects.animateClass
									.apply(this, [ k ? {
										add : n
									} : {
										remove : n
			...
			a.extend(a.effects, {
				...
				save : function(n, k) {
					for ( var m = 0; m < k.length; m++)
						k[m] !== null
								&& n.data("ec.storage." + k[m],
										n[0].style[k[m]])
				},
				restore : function(n, k) {
					for ( var m = 0; m < k.length; m++)
						k[m] !== null
								&& n.css(k[m], n.data("ec.storage." + k[m]))
				},
				setMode : function(n, k) {
					if (k == "toggle")
						k = n.is(":hidden") ? "show" : "hide";
					return k
				},
			...
			a.fn.extend( {
				...
				toggle : function(n) {
					if (f(n) || typeof n === "boolean" || a.isFunction(n))
					...
					.extend(
							a.easing,
							{
								...
								easeInOutBounce : function(n, k, m, p, q) {
									if (k < q / 2)
										return a.easing.easeInBounce(n, k * 2,
												0, p, q)
												* 0.5 + m;
									return a.easing.easeOutBounce(n, k * 2 - q,
											0, p, q)
											* 0.5 + p * 0.5 + m
								}
							})
...
(function(a) {
	a.effects.blind = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = [ "position", "top", "bottom", "left",
							"right" ], h = a.effects.setMode(d, c.options.mode
							|| "hide"), g = c.options.direction || "vertical";
					a.effects.save(d, e);
					d.show();
					var i = a.effects.createWrapper(d).css( {
						overflow : "hidden"
					...
					var f = {};
					f[b] = h == "show" ? g : 0;
					i.animate(f, c.duration, c.options.easing, function() {
						h == "hide" && d.hide();
	...
	a.effects.bounce = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = [ "position", "top", "bottom", "left",
							"right" ], h = a.effects.setMode(d, c.options.mode
							|| "effect"), g = c.options.direction || "up", i = c.options.distance || 20, b = c.options.times || 5, f = c.duration || 250;
					...
					i = c.options.distance || (j == "top" ? d.outerHeight( {
						margin : true
					}) / 3 : d.outerWidth( {
						margin : true
					}) / 3);
					if (h == "show")
						d.css("opacity", 0).css(j, g == "pos" ? -i : i);
					if (h == "hide")
						i /= b * 2;
					h != "hide" && b--;
					if (h == "show") {
						...
						l[j] = (g == "pos" ? "+=" : "-=") + i;
						d.animate(l, f / 2, c.options.easing);
						i /= 2;
						b--
					}
					for (l = 0; l < b; l++) {
						...
						o[j] = (g == "pos" ? "-=" : "+=") + i;
						n[j] = (g == "pos" ? "+=" : "-=") + i;
						d.animate(o, f / 2, c.options.easing).animate(n, f / 2,
								c.options.easing);
						i = h == "hide" ? i * 2 : i / 2
					}
					if (h == "hide") {
						...
						l[j] = (g == "pos" ? "-=" : "+=") + i;
						d.animate(l, f / 2, c.options.easing, function() {
							d.hide();
							a.effects.restore(d, e);
							a.effects.removeWrapper(d);
						...
						o[j] = (g == "pos" ? "-=" : "+=") + i;
						n[j] = (g == "pos" ? "+=" : "-=") + i;
						d.animate(o, f / 2, c.options.easing).animate(
								n,
								f / 2,
								c.options.easing,
								function() {
...
(function(a) {
	a.effects.clip = function(c) {
		return this.queue(function() {
			var d = a(this), e = [ "position", "top", "bottom", "left",
					"right", "height", "width" ], h = a.effects.setMode(d,
					c.options.mode || "hide"), g = c.options.direction
					|| "vertical";
			a.effects.save(d, e);
			d.show();
			var i = a.effects.createWrapper(d).css( {
...
(function(a) {
	a.effects.drop = function(c) {
		return this.queue(function() {
			var d = a(this), e = [ "position", "top", "bottom", "left",
					"right", "opacity" ], h = a.effects.setMode(d,
					c.options.mode || "hide"), g = c.options.direction
					|| "left";
			a.effects.save(d, e);
			d.show();
			...
			g = g == "up" || g == "left" ? "pos" : "neg";
			var b = c.options.distance || (i == "top" ? d.outerHeight( {
				margin : true
			}) / 2 : d.outerWidth( {
				margin : true
			}) / 2);
			if (h == "show")
				d.css("opacity", 0).css(i, g == "pos" ? -b : b);
			var f = {
				opacity : h == "show" ? 1 : 0
			};
			f[i] = (h == "show" ? g == "pos" ? "+=" : "-=" : g == "pos" ? "-="
					: "+=")
					+ b;
			d.animate(f, {
				queue : false,
	...
	a.effects.explode = function(c) {
		return this
				.queue(function() {
					...
					setTimeout(function() {
						c.options.mode == "show" ? h.css( {
							visibility : "visible"
						}) : h.css( {
							visibility : "visible"
						}).hide();
						c.callback && c.callback.apply(h[0]);
						h.dequeue();
...
(function(a) {
	a.effects.fade = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = a.effects.setMode(d, c.options.mode
							|| "hide");
					d.animate( {
						opacity : e
					}, {
	...
	a.effects.fold = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = [ "position", "top", "bottom", "left",
							"right" ], h = a.effects.setMode(d, c.options.mode
							|| "hide"), g = c.options.size || 15, i = !!c.options.horizFirst, b = c.duration ? c.duration / 2
							: a.fx.speeds._default / 2;
					a.effects.save(d, e);
					d.show();
					var f = a.effects.createWrapper(d).css( {
						overflow : "hidden"
					}), j = h == "show" != i, l = j ? [ "width", "height" ] : [
							"height", "width" ];
					j = j ? [ f.width(), f.height() ]
							: [ f.height(), f.width() ];
					var o = /([0-9]+)%/.exec(g);
					if (o)
						g = parseInt(o[1], 10) / 100 * j[h == "hide" ? 0 : 1];
					if (h == "show")
						f.css(i ? {
							height : 0,
							width : g
					...
					i[l[0]] = h == "show" ? j[0] : g;
					o[l[1]] = h == "show" ? j[1] : 0;
					f.animate(i, b, c.options.easing)
							.animate(
									o,
									b,
									c.options.easing,
...
(function(a) {
	a.effects.highlight = function(c) {
		return this.queue(function() {
			var d = a(this), e = [ "backgroundImage", "backgroundColor",
					"opacity" ], h = a.effects.setMode(d, c.options.mode
					|| "show"), g = {
...
(function(a) {
	a.effects.puff = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = a.effects.setMode(d, c.options.mode
							|| "hide"), h = parseInt(c.options.percent, 10) || 150, g = h / 100, i = {
						height : d.height(),
						width : d.width()
					};
					a.extend(c.options, {
	...
	a.effects.scale = function(c) {
		return this.queue(function() {
			var d = a(this), e = a.extend(true, {}, c.options), h = a.effects
					.setMode(d, c.options.mode || "effect"), g = parseInt(
					c.options.percent, 10)
					|| (parseInt(c.options.percent, 10) == 0 ? 0
							: h == "hide" ? 0 : 100), i = c.options.direction
					|| "both", b = c.options.origin;
			if (h != "effect") {
		...
		return this
				.queue(function() {
					var d = a(this), e = [ "position", "top", "bottom", "left",
							...
							"overflow", "opacity" ], g = [ "width", "height",
							"overflow" ], i = [ "fontSize" ], b = [
							"borderTopWidth", "borderBottomWidth",
							"paddingTop", "paddingBottom" ], f = [
							"borderLeftWidth", "borderRightWidth",
							"paddingLeft", "paddingRight" ], j = a.effects
							.setMode(d, c.options.mode || "effect"), l = c.options.restore || false, o = c.options.scale
							|| "both", n = c.options.origin, k = {
						height : d.height(),
						width : d.width()
					};
					d.from = c.options.from || k;
					d.to = c.options.to || k;
					if (n) {
						n = a.effects.getBaseline(n, k);
						d.from.top = (k.height - d.from.height) * n.y;
						d.from.left = (k.width - d.from.width) * n.x;
						d.to.top = (k.height - d.to.height) * n.y;
						d.to.left = (k.width - d.to.width) * n.x
					}
					var m = {
						from : {
							y : d.from.height / k.height,
							x : d.from.width / k.width
						},
						to : {
							y : d.to.height / k.height,
							x : d.to.width / k.width
						}
					};
					if (o == "box" || o == "both") {
						if (m.from.y != m.to.y) {
							e = e.concat(b);
							d.from = a.effects.setTransition(d, b, m.from.y,
									d.from);
							d.to = a.effects.setTransition(d, b, m.to.y, d.to)
						}
						if (m.from.x != m.to.x) {
							e = e.concat(f);
							d.from = a.effects.setTransition(d, f, m.from.x,
									d.from);
							d.to = a.effects.setTransition(d, f, m.to.x, d.to)
						}
					}
					if (o == "content" || o == "both")
						if (m.from.y != m.to.y) {
							e = e.concat(i);
							d.from = a.effects.setTransition(d, i, m.from.y,
									d.from);
							d.to = a.effects.setTransition(d, i, m.to.y, d.to)
						}
					a.effects.save(d, l ? e : h);
					d.show();
					a.effects.createWrapper(d);
					d.css("overflow", "hidden").css(d.from);
					if (o == "content" || o == "both") {
						b = b.concat( [ "marginTop", "marginBottom" ])
								.concat(i);
	...
	a.effects.shake = function(c) {
		return this
				.queue(function() {
					...
					var h = c.options.direction || "left", g = c.options.distance || 20, i = c.options.times || 3, b = c.duration
							|| c.options.duration || 140;
					a.effects.save(d, e);
					d.show();
					a.effects.createWrapper(d);
					var f = h == "up" || h == "down" ? "top" : "left", j = h == "up"
							|| h == "left" ? "pos" : "neg";
					h = {};
					var l = {}, o = {};
					h[f] = (j == "pos" ? "-=" : "+=") + g;
					l[f] = (j == "pos" ? "+=" : "-=") + g * 2;
					o[f] = (j == "pos" ? "-=" : "+=") + g * 2;
					d.animate(h, b, c.options.easing);
					for (g = 1; g < i; g++)
						d.animate(l, b, c.options.easing).animate(o, b,
								c.options.easing);
					d.animate(l, b, c.options.easing).animate(h, b / 2,
	...
	a.effects.slide = function(c) {
		return this
				.queue(function() {
					var d = a(this), e = [ "position", "top", "bottom", "left",
							"right" ], h = a.effects.setMode(d, c.options.mode
							|| "show"), g = c.options.direction || "left";
					a.effects.save(d, e);
					d.show();
...
(function(a) {
	a.effects.transfer = function(c) {
		return this.queue(function() {
			...
			h = d.offset();
			var g = a('<div class="ui-effects-transfer"></div>').appendTo(
			...
			.widget(
					"ui.accordion",
					{
						...
						_create : function() {
							...
							if (d.navigation) {
								var e = c.element.find("a").filter(
										d.navigationFilter).eq(0);
								if (e.length) {
									var h = e.closest(".ui-accordion-header");
									c.active = h.length ? h : e.closest(
						...
						_keydown : function(c) {
							if (!(this.options.disabled || c.altKey || c.ctrlKey)) {
								var d = a.ui.keyCode, e = this.headers.length, h = this.headers
										.index(c.target), g = false;
								switch (c.keyCode) {
								case d.RIGHT:
								case d.DOWN:
						...
						_clickHandler : function(c, d) {
							...
							if (!e.disabled)
								if (c.target) {
									...
									d = c[0] === this.active[0];
									e.active = e.collapsible && d ? false
									...
									if (!(this.running || !e.collapsible && d)) {
										...
										b = {
											options : e,
											newHeader : d && e.collapsible ? a( [])
													: c,
											oldHeader : this.active,
											newContent : d && e.collapsible ? a( [])
													: f,
											oldContent : i
										};
										var g = this.headers
						...
						_toggle : function(c, d, e, h, g) {
							...
							i.running = d.size() === 0 ? c.size() : d.size();
							if (b.animated) {
								e = {};
								e = b.collapsible && h ? {
									toShow : a( []),
								...
								b.animated = a.isFunction(b.proxied) ? b
										.proxied(e) : b.proxied;
								b.duration = a.isFunction(b.proxiedDuration) ? b
										.proxiedDuration(e)
										: b.proxiedDuration;
					...
					a.ui.accordion,
					{
						...
						animations : {
							slide : function(c, d) {
								...
								if (c.toHide.size())
									if (c.toShow.size()) {
										var e = c.toShow.css("overflow"), h = 0, g = {}, i = {}, b;
										d = c.toShow;
										b = d[0].style.width;
										d
										...
										a.each( [ "height", "paddingTop",
												"paddingBottom" ], function(f,
												j) {
											i[j] = "hide";
											f = ("" + a.css(c.toShow[0], j))
													.match(/^([\d+-.]+)(.*)$/);
											g[j] = {
												value : f[1],
												unit : f[2] || "px"
	...
	a
			.widget(
					"ui.autocomplete",
					{
						...
						pending : 0,
						_create : function() {
							var d = this, e = this.element[0].ownerDocument, h;
							this.element
									...
									.menu(
											{
												...
												selected : function(g, i) {
													var b = i.item
															.data("item.autocomplete"), f = d.previous;
						...
						_setOption : function(d, e) {
							...
							if (d === "appendTo")
								this.menu.element.appendTo(a(e || "body",
										this.element[0].ownerDocument)[0]);
							d === "disabled" && e && this.xhr
									&& this.xhr.abort()
						},
						...
						_suggest : function(d) {
							var e = this.menu.element.empty().zIndex(
						...
						_renderItem : function(d, e) {
							return a("<li></li>").data("item.autocomplete", e)
									.append(a("<a></a>").text(e.label))
									.appendTo(d)
						},
						_move : function(d, e) {
							if (this.menu.element.is(":visible"))
			...
			.widget(
					"ui.menu",
					{
						...
						activate : function(c, d) {
							...
							if (this.hasScroll()) {
								var e = d.offset().top
										- this.element.offset().top, h = this.element
										.scrollTop(), g = this.element.height();
								if (e < 0)
									this.element.scrollTop(h + e);
								else
									e >= g
											&& this.element.scrollTop(h + e - g
													+ d.height())
							}
						...
						move : function(c, d, e) {
							if (this.active) {
								c = this.active[c + "All"](".ui-menu-item").eq(
										0);
								c.length ? this.activate(e, c) : this.activate(
			...
			.widget(
					"ui.button",
					{
						...
						_determineButtonType : function() {
							...
							if (this.type === "checkbox"
									|| this.type === "radio") {
								var b = this.element.parents().filter(":last"), f = "label[for="
						...
						_setOption : function(b, f) {
							a.Widget.prototype._setOption
									.apply(this, arguments);
							if (b === "disabled")
								f ? this.element.propAttr("disabled", true)
						...
						refresh : function() {
							...
							if (this.type === "radio")
								i(this.element[0]).each(
										function() {
											a(this).is(":checked") ? a(this)
													.button("widget").addClass(
															"ui-state-active")
													.attr("aria-pressed",
															"true") : a(this)
													.button("widget")
	...
	a
			.widget(
					"ui.buttonset",
					{
						...
						_setOption : function(b, f) {
							b === "disabled"
									&& this.buttons.button("option", b, f);
							a.Widget.prototype._setOption
									.apply(this, arguments)
						},
						refresh : function() {
						...
						function(f) {
							...
							if (!(a.datepicker
									._isDisabledDatepicker(i.inline ? b
											.parent()[0] : i.input[0]) || !f.length)) {
								f.parents(".ui-datepicker-calendar").find("a")
										.removeClass("ui-state-hover");
								f.addClass("ui-state-hover");
								f.hasClass("ui-datepicker-prev")
										&& f
												.addClass("ui-datepicker-prev-hover");
								f.hasClass("ui-datepicker-next")
										&& f
			...
			.extend(
					d.prototype,
					{
						...
						_attachDatepicker : function(b, f) {
							...
							if (l == "input")
								this._connectDatepicker(b, k);
							else
								o && this._inlineDatepicker(b, k)
						},
						...
						_connectDatepicker : function(b, f) {
							...
							if (!j.hasClass(this.markerClassName)) {
								...
								j.addClass(this.markerClassName).keydown(
						...
						_attachments : function(b, f) {
							var j = this._get(f, "appendText"), l = this._get(
									f, "isRTL");
							...
							if (j == "button" || j == "both") {
								...
								f.trigger = a(this._get(f, "buttonImageOnly") ? a(
						...
						_autoSize : function(b) {
							if (this._get(b, "autoSize") && !b.inline) {
								var f = new Date(2009, 11, 20), j = this._get(
										b, "dateFormat");
								if (j.match(/[DM]/)) {
									var l = function(o) {
									...
									f.setMonth(l(this._get(b,
											j.match(/MM/) ? "monthNames"
													: "monthNamesShort")));
									f.setDate(l(this._get(b,
											j.match(/DD/) ? "dayNames"
													: "dayNamesShort"))
											+ 20 - f.getDay())
								}
								b.input.attr("size",
										this._formatDate(b, f).length)
							}
						},
						...
						_dialogDatepicker : function(b, f, j, l, o) {
							...
							h(b.settings, l || {});
							f = f && f.constructor == Date ? this._formatDate(
									b, f) : f;
							this._dialogInput.val(f);
							this._pos = o ? o.length ? o : [ o.pageX, o.pageY ]
									: null;
							if (!this._pos)
								this._pos = [
						...
						_destroyDatepicker : function(b) {
							...
							if (f.hasClass(this.markerClassName)) {
								...
								if (l == "input") {
									j.append.remove();
									j.trigger.remove();
									f.removeClass(this.markerClassName).unbind(
						...
						_optionDatepicker : function(b, f, j) {
							...
							if (arguments.length == 2 && typeof f == "string")
								return f == "defaults" ? a.extend( {},
										a.datepicker._defaults)
										: l ? f == "all" ? a.extend( {},
												l.settings) : this._get(l, f)
												: null;
							var o = f || {};
							if (typeof f == "string") {
								o = {};
							...
							if (l) {
								...
								var n = this._getDateDatepicker(b, true), k = this
										._getMinMaxDate(l, "min"), m = this
										._getMinMaxDate(l, "max");
								h(l.settings, o);
								if (k !== null && o.dateFormat !== c
										&& o.minDate === c)
									l.settings.minDate = this._formatDate(l, k);
								if (m !== null && o.dateFormat !== c
										&& o.maxDate === c)
						...
						_getDateDatepicker : function(b, f) {
							(b = this._getInst(b)) && !b.inline
									&& this._setDateFromField(b, f);
							return b ? this._getDate(b) : null
						},
						_doKeyDown : function(b) {
							var f = a.datepicker._getInst(b.target), j = true, l = f.dpDiv
							...
							if (a.datepicker._datepickerShowing)
								...
								case 9:
									...
									break;
								case 13:
									j = a("td." + a.datepicker._dayOverClass
											+ ":not(."
											+ a.datepicker._currentClass + ")",
											f.dpDiv);
									j[0]
											&& a.datepicker._selectDay(
													b.target, f.selectedMonth,
													f.selectedYear, j[0]);
						...
						_doKeyPress : function(b) {
							...
							if (a.datepicker._get(f, "constrainInput")) {
								f = a.datepicker._possibleChars(a.datepicker
										._get(f, "dateFormat"));
								var j = String
										.fromCharCode(b.charCode == c ? b.keyCode
												: b.charCode);
								return b.ctrlKey || b.metaKey || j < " " || !f
										|| f.indexOf(j) > -1
							}
						},
						_doKeyUp : function(b) {
						...
						_showDatepicker : function(b) {
							...
							if (!(a.datepicker._isDisabledDatepicker(b) || a.datepicker._lastInput == b)) {
								...
								if (!f.inline) {
									...
									a.effects && a.effects[j] ? f.dpDiv
											.show(j, a.datepicker._get(f,
													"showOptions"), o, n)
											: f.dpDiv[j || "show"](
													j ? o : null, n);
									if (!j || !o)
						...
						_updateDatepicker : function(b) {
							...
							b.dpDiv.find("." + this._dayOverClass + " a")
									.mouseover();
							...
							j > 1
									&& b.dpDiv.addClass(
											"ui-datepicker-multi-" + j).css(
											"width", 17 * j + "em");
							b.dpDiv[(f[0] != 1 || f[1] != 1 ? "add" : "remove")
						...
						_getBorders : function(b) {
							...
							return [ parseFloat(f(b.css("border-left-width"))),
									parseFloat(f(b.css("border-top-width"))) ]
						},
						_checkOffset : function(b, f, j) {
							var l = b.dpDiv.outerWidth(), o = b.dpDiv
									.outerHeight(), n = b.input ? b.input
									.outerWidth() : 0, k = b.input ? b.input
									.outerHeight() : 0, m = document.documentElement.clientWidth
									+ a(document).scrollLeft(), p = document.documentElement.clientHeight
									+ a(document).scrollTop();
							f.left -= this._get(b, "isRTL") ? l - n : 0;
							f.left -= j && f.left == b.input.offset().left ? a(
									document).scrollLeft() : 0;
							f.top -= j && f.top == b.input.offset().top + k ? a(
									document).scrollTop()
									: 0;
							f.left -= Math.min(f.left,
									f.left + l > m && m > l ? Math.abs(f.left
											+ l - m) : 0);
							f.top -= Math.min(f.top,
									f.top + o > p && p > o ? Math.abs(o + k)
											: 0);
							return f
						},
						_findPos : function(b) {
							for ( var f = this._get(this._getInst(b), "isRTL"); b
						...
						_hideDatepicker : function(b) {
							...
							if (!(!f || b && f != a.data(b, "datepicker")))
								if (this._datepickerShowing) {
									...
									a.effects && a.effects[b] ? f.dpDiv
											.hide(b, a.datepicker._get(f,
													"showOptions"), j, l)
						...
						_adjustDate : function(b, f, j) {
							...
							if (!this._isDisabledDatepicker(b[0])) {
								this._adjustInstDate(l, f
										+ (j == "M" ? this._get(l,
												"showCurrentAtPos") : 0), j);
								this._updateDatepicker(l)
							}
						},
						...
						_selectMonthYear : function(b, f, j) {
							b = a(b);
							var l = this._getInst(b[0]);
							l["selected" + (j == "M" ? "Month" : "Year")] = l["draw"
									+ (j == "M" ? "Month" : "Year")] = parseInt(
									f.options[f.selectedIndex].value, 10);
							this._notifyChange(l);
							this._adjustDate(b)
						},
						_selectDay : function(b, f, j, l) {
							var o = a(b);
							if (!(a(l).hasClass(this._unselectableClass) || this
								...
								this._selectDate(b, this._formatDate(o,
										o.currentDay, o.currentMonth,
										o.currentYear))
							}
						},
						...
						_selectDate : function(b, f) {
							...
							if (j)
								j.apply(b.input ? b.input[0] : null, [ f, b ]);
							else
						...
						_updateAlternate : function(b) {
							...
							if (f) {
								var j = this._get(b, "altFormat")
										|| this._get(b, "dateFormat"), l = this
										._getDate(b), o = this.formatDate(j, l,
						...
						parseDate : function(b, f, j) {
							...
							if (f == "")
								return null;
							var l = (j ? j.shortYearCutoff : null)
									|| this._defaults.shortYearCutoff;
							l = typeof l != "string" ? l : (new Date)
									.getFullYear()
									% 100 + parseInt(l, 10);
							for ( var o = (j ? j.dayNamesShort : null)
							...
							C = this
									._daylightSavingAdjust(new Date(j, p - 1, q));
							if (C.getFullYear() != j || C.getMonth() + 1 != p
									|| C.getDate() != q)
								throw "Invalid date";
							return C
						},
						...
						_get : function(b, f) {
							return b.settings[f] !== c ? b.settings[f]
									: this._defaults[f]
						},
						_setDateFromField : function(b, f) {
							if (b.input.val() != b.lastVal) {
								var j = this._get(b, "dateFormat"), l = b.lastVal = b.input ? b.input
										.val()
										: null, o, n;
						...
						_determineDate : function(b, f, j) {
							var l = function(n) {
								...
								var m = (n.toLowerCase().match(/^c/) ? a.datepicker
										._getDate(b)
										: null)
										|| new Date, p = m.getFullYear(), q = m
										.getMonth();
								m = m.getDate();
						...
						_setDate : function(b, f, j) {
							...
							f = this._restrictMinMax(b, this._determineDate(b,
									f, new Date));
							...
							this._adjustInstDate(b);
							if (b.input)
								b.input.val(l ? "" : this._formatDate(b));
							if (j = this._get(b, "onSelect")) {
								l = this._formatDate(b);
								j.apply(b.input ? b.input[0] : null, [ l, b ])
							}
						},
						_getDate : function(b) {
						...
						_generateHTML : function(b) {
							var f = new Date;
							f = this._daylightSavingAdjust(new Date(f
									.getFullYear(), f.getMonth(), f.getDate()));
							var j = this._get(b, "isRTL"), l = this._get(b,
									"showButtonPanel"), o = this._get(b,
									"hideIfNoPrevNext"), n = this._get(b,
									"navigationAsDateFormat"), k = this
									._getNumberOfMonths(b), m = this._get(b,
									"showCurrentAtPos"), p = this._get(b,
									"stepMonths"), q = k[0] != 1 || k[1] != 1, s = this
									._daylightSavingAdjust(!b.currentDay ? new Date(
											9999, 9, 9)
											: new Date(b.currentYear,
													b.currentMonth,
													b.currentDay)), r = this
									._getMinMaxDate(b, "min"), u = this
							...
							if (u) {
								var w = this._daylightSavingAdjust(new Date(u
										.getFullYear(), u.getMonth() - k[0]
										* k[1] + 1, u.getDate()));
								for (w = r && w < r ? r : w; this
										._daylightSavingAdjust(new Date(v, m, 1)) > w;) {
									m--;
									if (m < 0) {
										m = 11;
										v--
							...
							w = !n ? w : this.formatDate(w,
									this._daylightSavingAdjust(new Date(v, m
											- p, 1)), this._getFormatConfig(b));
							w = this._canAdjustMonth(b, -1, v, m) ? '<a class="ui-datepicker-prev ui-corner-all" onclick="DP_jQuery_'
									+ g
							...
							x = !n ? x : this.formatDate(x,
									this._daylightSavingAdjust(new Date(v, m
											+ p, 1)), this._getFormatConfig(b));
							o = this._canAdjustMonth(b, +1, v, m) ? '<a class="ui-datepicker-next ui-corner-all" onclick="DP_jQuery_'
									+ g
									+ ".datepicker._adjustDate('#"
									+ b.id
									+ "', +"
							...
							x = this._get(b, "gotoCurrent") && b.currentDay ? s
									: f;
							p = !n ? p : this.formatDate(p, x, this
									._getFormatConfig(b));
							...
							l = l ? '<div class="ui-datepicker-buttonpane ui-widget-content">'
									+ (j ? n : "")
									+ (this._isInRange(b, x) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" onclick="DP_jQuery_'
											+ g
							...
							var y = this._get(b, "dayNamesMin"), H = this._get(
									b, "monthNames"), C = this._get(b,
									"monthNamesShort"), z = this._get(b,
									"beforeShowDay"), I = this._get(b,
									"showOtherMonths"), N = this._get(b,
									"selectOtherMonths");
								...
								for ( var L = 0; L < k[1]; L++) {
									var Q = this
											._daylightSavingAdjust(new Date(v,
													m, b.selectedDay)), B = " ui-corner-all", F = "";
									if (q) {
									...
									F += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'
											+ B
											+ '">'
											+ (/all|left/.test(B) && E == 0 ? j ? o
													: w
													: "")
											+ (/all|right/.test(B) && E == 0 ? j ? w
													: o
													: "")
									...
									this.maxRows = G = q ? this.maxRows > G ? this.maxRows
											: G
											: G;
									A = this._daylightSavingAdjust(new Date(v,
											m, 1 - B));
									for ( var R = 0; R < G; R++) {
										F += "<tr>";
										var S = !p ? ""
						...
						_generateMonthYearHeader : function(b, f, j, l, o, n,
								k, m) {
							var p = this._get(b, "changeMonth"), q = this._get(
									b, "changeYear"), s = this._get(b,
						...
						_adjustInstDate : function(b, f, j) {
							var l = b.drawYear + (j == "Y" ? f : 0), o = b.drawMonth
									+ (j == "M" ? f : 0);
							f = Math.min(b.selectedDay, this._getDaysInMonth(l,
									o))
									+ (j == "D" ? f : 0);
							l = this._restrictMinMax(b, this
									._daylightSavingAdjust(new Date(l, o, f)));
						...
						_getMinMaxDate : function(b, f) {
							return this._determineDate(b, this._get(b, f
									+ "Date"), null)
						},
						_getDaysInMonth : function(b, f) {
							return 32 - this._daylightSavingAdjust(
									new Date(b, f, 32)).getDate()
						},
						...
						_canAdjustMonth : function(b, f, j, l) {
							...
							j = this._daylightSavingAdjust(new Date(j, l
									+ (f < 0 ? f : o[0] * o[1]), 1));
							f < 0
									&& j.setDate(this._getDaysInMonth(j
											.getFullYear(), j.getMonth()));
							return this._isInRange(b, j)
						},
						_isInRange : function(b, f) {
							var j = this._getMinMaxDate(b, "min");
							b = this._getMinMaxDate(b, "max");
							return (!j || f.getTime() >= j.getTime())
									&& (!b || f.getTime() <= b.getTime())
						},
						_getFormatConfig : function(b) {
							var f = this._get(b, "shortYearCutoff");
							f = typeof f != "string" ? f : (new Date)
									.getFullYear()
									% 100 + parseInt(f, 10);
							return {
								shortYearCutoff : f,
						...
						_formatDate : function(b, f, j, l) {
							...
							f = f ? typeof f == "object" ? f : this
									._daylightSavingAdjust(new Date(l, j, f))
									: this._daylightSavingAdjust(new Date(
											b.currentYear, b.currentMonth,
											b.currentDay));
							return this.formatDate(this._get(b, "dateFormat"),
									f, this._getFormatConfig(b))
						}
					});
	a.fn.datepicker = function(b) {
		...
		return this.each(function() {
			typeof b == "string" ? a.datepicker["_" + b + "Datepicker"].apply(
					a.datepicker, [ this ].concat(f)) : a.datepicker
			...
			.widget(
					"ui.dialog",
					{
						...
						_create : function() {
							...
							g.element.show().removeAttr("title").addClass(
									"ui-dialog-content ui-widget-content")
									.appendTo(j);
							var l = (g.uiDialogTitlebar = a("<div></div>"))
									.addClass(
											"ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix")
									.prependTo(j), o = a('<a href="#"></a>')
									.addClass(
							...
							(g.uiDialogTitlebarCloseText = a("<span></span>"))
									...
									.text(i.closeText).appendTo(o);
							a("<span></span>").addClass("ui-dialog-title")
									.attr("id", f).html(b).prependTo(l);
							if (a.isFunction(i.beforeclose)
									&& !a.isFunction(i.beforeClose))
						...
						open : function() {
							if (!this._isOpen) {
								...
								g.overlay = i.modal ? new a.ui.dialog.overlay(g)
										: null;
								g._size();
						...
						_createButtons : function(g) {
							var i = this, b = false, f = a("<div></div>")
									.addClass(
						...
						_minHeight : function() {
							var g = this.options;
							return g.height === "auto" ? g.minHeight : Math
									.min(g.minHeight, g.height)
						},
						_position : function(g) {
							var i = [], b = [ 0, 0 ], f;
							if (g) {
								if (typeof g === "string"
										|| typeof g === "object" && "0" in g) {
						...
						_setOption : function(g, i) {
							...
							case "closeText":
								...
								break;
							case "dialogClass":
								f.removeClass(b.options.dialogClass).addClass(
										"ui-dialog ui-widget ui-widget-content ui-corner-all "
												+ i);
								break;
							case "disabled":
								i ? f.addClass("ui-dialog-disabled") : f
							...
							case "resizable":
								...
								break;
							case "title":
								a(".ui-dialog-title", b.uiDialogTitlebar).html(
										"" + (i || "&#160;"));
								break
							}
						...
						_size : function() {
							...
							if (g.height === "auto")
								if (a.support.minHeight)
									...
									this.uiDialog.show();
									g = this.element.css("height", "auto")
											.height();
									f || this.uiDialog.hide();
									this.element.height(Math.max(g, b))
								}
							else
								this.element.height(Math.max(g.height - i, 0));
							this.uiDialog.is(":data(resizable)")
			...
			.extend(
					a.ui.dialog.overlay,
					{
						...
						create : function(g) {
							...
							var i = (this.oldInstances.pop() || a("<div></div>")
						...
						height : function() {
							...
							if (a.browser.msie && a.browser.version < 7) {
								...
								return g < i ? a(window).height() + "px" : g
										+ "px"
							} else
						...
						width : function() {
							...
							if (a.browser.msie) {
								...
								return g < i ? a(window).width() + "px" : g
										+ "px"
							} else
...
(function(a) {
	a.ui = a.ui || {};
	var c = /left|center|right/, d = /top|center|bottom/, e = a.fn.position, h = a.fn.offset;
	a.fn.position = function(g) {
		if (!g || !g.of)
			return e.apply(this, arguments);
		g = a.extend( {}, g);
		var i = a(g.of), b = i[0], f = (g.collision || "flip").split(" "), j = g.offset ? g.offset
				.split(" ")
				: [ 0, 0 ], l, o, n;
		if (b.nodeType === 9) {
			l = i.width();
		...
		a.each( [ "my", "at" ], function() {
			var k = (g[this] || "").split(" ");
			if (k.length === 1)
				k = c.test(k[0]) ? k.concat( [ "center" ])
						: d.test(k[0]) ? [ "center" ].concat(k) : [ "center",
								"center" ];
			k[0] = c.test(k[0]) ? k[0] : "center";
			k[1] = d.test(k[1]) ? k[1] : "center";
			g[this] = k
		});
		if (f.length === 1)
			f[1] = f[0];
		...
		return this
				.each(function() {
					var k = a(this), m = k.outerWidth(), p = k.outerHeight(), q = parseInt(a
							.curCSS(this, "marginLeft", true)) || 0, s = parseInt(a
							.curCSS(this, "marginTop", true)) || 0, r = m
							+ q
							+ (parseInt(a.curCSS(this, "marginRight", true)) || 0), u = p
							+ s
							+ (parseInt(a.curCSS(this, "marginBottom", true)) || 0), v = a
							.extend( {}, n), w;
					if (g.my[0] === "right")
						v.left -= m;
	...
	a.ui.position = {
		fit : {
			left : function(g, i) {
				var b = a(window);
				b = i.collisionPosition.left + i.collisionWidth - b.width()
						- b.scrollLeft();
				g.left = b > 0 ? g.left - b : Math.max(g.left
						- i.collisionPosition.left, g.left)
			},
			top : function(g, i) {
				var b = a(window);
				b = i.collisionPosition.top + i.collisionHeight - b.height()
						- b.scrollTop();
			...
			left : function(g, i) {
				if (i.at[0] !== "center") {
					...
					var f = i.my[0] === "left" ? -i.elemWidth
							: i.my[0] === "right" ? i.elemWidth : 0, j = i.at[0] === "left" ? i.targetWidth
							: -i.targetWidth, l = -2 * i.offset[0];
					g.left += i.collisionPosition.left < 0 ? f + j + l
							: b > 0 ? f + j + l : 0
				}
			},
			top : function(g, i) {
				if (i.at[1] !== "center") {
					var b = a(window);
					b = i.collisionPosition.top + i.collisionHeight
							- b.height() - b.scrollTop();
					var f = i.my[1] === "top" ? -i.elemHeight
							: i.my[1] === "bottom" ? i.elemHeight : 0, j = i.at[1] === "top" ? i.targetHeight
							: -i.targetHeight, l = -2 * i.offset[1];
					g.top += i.collisionPosition.top < 0 ? f + j + l
							: b > 0 ? f + j + l : 0
				}
			}
		}
	...
	if (!a.offset.setOffset) {
		a.offset.setOffset = function(g, i) {
			...
			var b = a(g), f = b.offset(), j = parseInt(
					a.curCSS(g, "top", true), 10) || 0, l = parseInt(a.curCSS(
					g, "left", true), 10) || 0;
			f = {
				top : i.top - f.top + j,
			...
			.widget(
					"ui.progressbar",
					{
						...
						_refreshValue : function() {
							var d = this.value(), e = this._percentage();
							if (this.oldValue !== d) {
								this.oldValue = d;
								this._trigger("change")
							}
							this.valueDiv.toggle(d > this.min).toggleClass(
									"ui-corner-right", d === this.options.max)
									.width(e.toFixed(0) + "%");
	...
	a
			.widget(
					...
					a.ui.mouse,
					{
						...
						_create : function() {
							var c = this, d = this.options, e = this.element
									.find(".ui-slider-handle").addClass(
											"ui-state-default ui-corner-all"), h = d.values
									&& d.values.length || 1, g = [];
							...
							this.handles = e.add(a(g.join("")).appendTo(
									c.element));
						...
						_refreshValue : function() {
							var c = this.options.range, d = this.options, e = this, h = !this._animateOff ? d.animate
									: false, g, i = {}, b, f, j, l;
							if (this.options.values
									&& this.options.values.length)
								this.handles
										.each(function(o) {
											g = (e.values(o) - e._valueMin())
													/ (e._valueMax() - e
															._valueMin()) * 100;
											i[e.orientation === "horizontal" ? "left"
													: "bottom"] = g + "%";
											a(this).stop(1, 1)[h ? "animate"
													: "css"](i, d.animate);
								...
								i[e.orientation === "horizontal" ? "left"
										: "bottom"] = g + "%";
								this.handle.stop(1, 1)[h ? "animate" : "css"](
										i, d.animate);
								if (c === "min"
					...
					"ui.tabs",
					{
						...
						_cookie : function() {
							var i = this.cookie
									|| (this.cookie = this.options.cookie.name
											|| "ui-tabs-" + e());
							return a.cookie.apply(null, [ i ].concat(a
									.makeArray(arguments)))
						},
						_ui : function(i, b) {
							return {
						...
						_tabify : function(i) {
							...
							if (i) {
								...
								if (j.selected === c) {
									...
									if (typeof j.selected !== "number"
											&& j.cookie)
										j.selected = parseInt(f._cookie(), 10);
									if (typeof j.selected !== "number"
											&& this.lis
								...
								j.disabled = a.unique(
										j.disabled.concat(a.map(this.lis
												.filter(".ui-state-disabled"),
												function(r) {
													return f.lis.index(r)
												}))).sort();
								a.inArray(j.selected, j.disabled) != -1
										&& j.disabled.splice(a.inArray(
							...
							for ( var o; o = this.lis[i]; i++)
								a(o)[a.inArray(i, j.disabled) != -1
										&& !a(o).hasClass("ui-tabs-selected") ? "addClass"
						...
						_getIndex : function(i) {
							if (typeof i == "string")
								i = this.anchors.index(this.anchors
										.filter("[href$=" + i + "]"));
							return i
						},
						destroy : function() {
						...
						add : function(i, b, f) {
							...
							b = a(l.tabTemplate.replace(/#\{href\}/g, i)
									.replace(/#\{label\}/g, b));
							i = !i.indexOf("#") ? i.replace("#", "") : this
									._tabId(a("a", b)[0]);
							b.addClass("ui-state-default ui-corner-top").data(
									"destroy.tabs", true);
							var o = j.element.find("#" + i);
							o.length
									|| (o = a(l.panelTemplate).attr("id", i)
							...
							this._trigger("add", null, this._ui(
									this.anchors[f], this.panels[f]));
							return this
						},
						remove : function(i) {
							i = this._getIndex(i);
							var b = this.options, f = this.lis.eq(i).remove(), j = this.panels
									.eq(i).remove();
						...
						load : function(i) {
							...
							var b = this, f = this.options, j = this.anchors
									.eq(i)[0], l = a.data(j, "load.tabs");
							this.abort();
							if (!l || this.element.queue("tabs").length !== 0
									&& a.data(j, "cache.tabs"))
						...
						url : function(i, b) {
							this.anchors.eq(i).removeData("cache.tabs").data(
									"load.tabs", b);
							return this
						},
						length : function() {
