...
if($_REQUEST["operation"] && strpos("_", $_REQUEST["operation"]) !== 0 && method_exists($jstree, $_REQUEST["operation"])) {
	...
	echo '[{"attr":{"id":"node_9","rel":"drive"},
			"data":"hello",
			"state":""},
		   {"attr":{"id":"node_98","rel":"default"},
		    "data":"aga",
		    "state":""},
		   {"attr":{"id":"node_192","rel":"default"},
		    "data":"bla",
		    "state":""},
		   {"attr":{"id":"node_168","rel":"default"},
		    "data":"New node",
		    "state":""},
		   {"attr":{"id":"node_182","rel":"folder"},
		    "data":"dfg",
		    "state":"closed"},
		   {"attr":{"id":"node_196","rel":"default"},
		    "data":"win?",
		    "state":""}]';
