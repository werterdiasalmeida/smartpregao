		...
		<? if ($_REQUEST['indid'] && $_REQUEST['sehid']){ ?>
			...
			GDownloadUrl(xml_filtro, function(data) {
		        ...
		        setTimeout("disponibilizaMapa()",5000);
					...
					alert('Marcadores não disponíveis!');
					disponibilizaMapa();
					}
	        });
...
<div id="carregando_mapas" style="position:absolute;top:50%;left:30%;z-index:999999;width:300px;text-align:center;background-color:#FFFFFF;border:#000000 solid 1px;padding:5px;"  ><img src="../imagens/wait.gif" /> Carregando municípios...</div>
