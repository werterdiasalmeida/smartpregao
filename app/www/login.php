...
if(isset($_POST['act'])){
    switch($_POST['act']){
        ...
        case 'recuperar':
            ...
            $sql = sprintf("SELECT u.* FROM seguranca.usuario u WHERE (u.usucpf = '%s' OR u.usuemail = '%s')",
                corrige_cpf($_REQUEST['usucpf']), $_REQUEST['usucpf']
            );
            ...
            $sql = sprintf("UPDATE seguranca.usuario SET ususenha = '%s', usuchaveativacao = 'f', usumigrado = 'f' WHERE usucpf = '%s'",
...
<div class="content">
    ...
    <form class="login-form" action="/" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off"
                   placeholder="Email ou CPF" name="usucpf"/></div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Senha</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off"
                   placeholder="Senha" name="ususenha"/></div>
    ...
    <form class="forget-form" action="/" method="post">
        ...
        <div class="form-group">
            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email ou CPF"
                   name="usucpf"/></div>
        <div class="form-actions">
    ...
    <form class="register-form" action="/" method="post">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Senha</label>
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="ususenha"
                   placeholder="Senha" name="ususenha" maxlength="50" />
        </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Confirmar senha</label>
            <input class="form-control placeholder-no-fix" type="password" autocomplete="off"
                   placeholder="Confirmar senha" name="rususenha"/></div>
        <div class="form-actions">
...
<script type="text/javascript">
    $(function(){
        ...
        $(".login-form").validate({
            ...
            focusInvalid: false,
            rules: {usucpf: {required: true}, ususenha: {required: true}},
            messages: {usucpf: {required: "Email é obrigatório."}, ususenha: {required: "Senha é obrigatória."}},
        ...
        $(".forget-form").validate({
            ...
            focusInvalid: false,
            ignore: "",
            rules: {usucpf: {required: true}},
            messages: {usucpf: {required: "Email é obrigatório."}},
            invalidHandler: function (e, r) {
        ...
        $(".register-form").validate({
            ...
            ignore: "",
            rules: {
                usunome: {required: true},
                usucpf: {required: true, cpf: true},
                usudatanascimento: {required: true, dateITA : true},
                ususexo: {required: true},
                usufonenum: {required: true},
                usuemail: {required: true, email: true},
                ususenha: {required: true, minlength:8},
                rususenha: {equalTo: "#ususenha"}
            },
            messages: {},
            invalidHandler: function (e, r) {
            },
            ...
            submitHandler: function (e) {
                ...
                $.ajax({
                    ...
                    url : 'login.php',
                    dataType : 'json',
                    data : {act : 'verificar', usucpf : form.find('[name=usucpf]').val(), usuemail : form.find('[name=usuemail]').val()},
